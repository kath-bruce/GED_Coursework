...
public class Regent extends Decorator {

    Character character;

    public Regent(Character character) {
    ...
    public void resetDefaults() {
        this.character.setName("Regent " + this.character.getName());
        this.character.setMaxHealth(this.character.getMaxHealth() + 50);
        this.character.setHealth(this.character.getMaxHealth());
        this.character.setMaxEnergy(this.character.getMaxEnergy() + 100);
