...
public class Supreme extends Decorator {

    Character character;

    public Supreme(Character character) {
    ...
    public void resetDefaults() {
        this.character.setName("Supreme " + this.character.getName());
        this.character.setMaxHealth(this.character.getMaxHealth() + 150);
        this.character.setHealth(this.character.getMaxHealth());
        this.character.setMaxEnergy(this.character.getMaxEnergy() + 200);
        this.character.setEnergy(this.character.getMaxEnergy());
        this.character.setStrength(this.character.getStrength() + 3);
        this.character.setEnergyUsage(this.character.getEnergyUsage() - 3);
        ...
        if (this.character.getLevel() == null) {
            this.character.setXP(this.character.getXP() + 4);
